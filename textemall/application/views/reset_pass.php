	...
	<div class="container">
		<!--Reg Block-->
				...
				<p>or Click <a class="color-green" href="<?php echo base_url() ?>">Sign In</a> to login your account.</p>
                                <h4 class="margin-top-20">Please enter new password</h4>
                    </div>
                    
                    <?php echo validation_errors('<div class="alert alert-danger">', '</div>'); ?>
                    
                        <form action="<?php echo site_url('LoginController/resetPass')?>" method="post">
				...
				<div class="col-md-10 col-md-offset-1">
					...
					<button type="submit" class="btn-u btn-block">Save Changes</button>
