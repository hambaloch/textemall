	...
	<div class="container">
		<!--Reg Block-->
				...
				<p>or Click <a class="color-green" href="<?php echo base_url() ?>">Sign In</a> to login your account.</p>
                                <h4 class="margin-top-20">Please enter verification code</h4>
                    </div>
                    
                    <?php echo validation_errors('<div class="alert alert-danger">', '</div>'); ?>
                    
                        <form action="<?php echo site_url('LoginController/resetCode')?>" method="post">
                            
                            <?php echo isset($error)? "<div class='alert alert-danger'>" . $error . "</div>" : ''; ?>
			
                            <div class="input-group margin-bottom-40">
				<span class="input-group-addon"><i class="fa fa-key"></i></span>
				<input type="text" name="verificationCode" value="<?php echo set_value('verificationCode'); ?>" class="form-control" placeholder="Verification Code" required>
                            </div>
